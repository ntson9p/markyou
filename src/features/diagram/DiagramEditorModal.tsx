...
import { fitDiagram, renderMermaidToSvg } from '@/editors/preview/mermaid';
    ...
    <div className="flex h-full min-h-0 flex-col">
      ...
      <div className="min-h-0 flex-1 overflow-auto">
        <div
          ...
          aria-live="polite"
          // `diagram-preview` carries the readability floor (wysiwyg.css);
          // width is otherwise mermaid's own inline rules, which outrank any
          // we could write. Centring is `mx-auto` on the diagram rather than
          // `justify-center`, which would put the left edge of an over-wide
          // one outside the scroll range.
          className="diagram-preview flex min-h-full items-center p-4 [&_svg]:mx-auto [&_svg]:h-auto"
        />
      </div>
      {error && (
        <div
