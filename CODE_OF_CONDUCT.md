...
- Being welcoming to newcomers, and generous about the fact that everyone was one once
- Giving and gracefully accepting constructive feedback
- Focusing on what is best for the project rather than on winning an argument
...
This Code of Conduct applies within all project spaces — the issue tracker, pull requests,
discussions, and commit history — and also applies when an individual is officially
...
maintainers at **nguyentruongson6789p@gmail.com**. All complaints will be reviewed and investigated
...
1. **Correction** — A private, written warning providing clarity about the nature of the
   violation and why the behaviour was inappropriate. A public apology may be requested.
2. **Warning** — A warning with consequences for continued behaviour, including a period of
